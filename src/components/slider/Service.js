...
import './services.css'
import { FaStar } from 'react-icons/fa'
import Ellipse from '../../assets/img/Ellipse 13.png'
import Ellipse1 from '../../assets/img/Ellipse 12.png'
import Ellipse2 from '../../assets/Logo/services.png'
import Carousel from 'react-elastic-carousel'
import Item from './Item'
...
function service() {
  ...
  return (
    <div>
      <section id="testimonials" className="services-area serviceSection services-eight">
        {/* <!--======  Start Section Title Five ======--> */}
        <div className="section-title-five">
          <div className="container">
            <div className="row">
