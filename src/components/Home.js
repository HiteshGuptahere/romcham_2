        ...
        <div className="row">
          ...
          <div className="col-md-6 col-12">
            <div className={`${styles.visionAbout}`}>
              <h5>about us</h5>
              <p>
                To build a Business platform and Open Forum willing to bring significance and
                opening new and solid bridges through constructive dialog and comprehensive
