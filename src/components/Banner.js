  ...
  return (
    <>
      <div style={{ position: 'relative' }}>
        <img src={banner1} className={`img-fluid w-100 ${styles.ig}`} alt="banner1" />
        <div className={`${styles.bannerHeadAlign}`}>
          ...
          <p>
            We serve and support a better business landscape build by authorities and top <br></br>
            business professionals together.
          </p>
          <button className={`btn btn-primary ${styles.bannerBtn}`}>Create event</button>
        </div>
