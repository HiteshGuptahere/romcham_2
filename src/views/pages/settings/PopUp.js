			...
			<div className="card" style={{ width: "900px", height: "650px", background: "#F8F9FF" }}>
				<div className="card-body">
					...
					<form className='forms'>
						<label for="email" className="form-label">Select Group</label>
						...
						<input type="text" className="form-control" id="text" placeholder="Type here..." name="email" />
						<br />
						<b className='title'>+ADD A LINK</b>&nbsp;&nbsp;&nbsp;
						<b className='title'>+ATTACH FILE</b>
						<br /><br />
						<label for="email" className="form-label">Add Link</label>
						<input type="text" className="form-control" id="text" placeholder="Type here.." name="email" />
						<br />
