                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                    <div className={`card mt-2 shadow ${styles.card1}`}>
                        <div className="card-body">
                            ...
                            <div className='d-flex'>
                                ...
                                <div className='ms-3'>
                                    <p>   <FaCalendarAlt className={`${styles.fontawesome}`} /> July 7,2021</p>
                                </div>
                            </div>
                    ...
                    <div className={`card mb-5 mt-4 shadow ${styles.card1}`}>
                        <div className="card-body">
                            ...
                            <h6 className='text-capitalize mt-4'>summer time on neptune is <br></br>
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                    <div className={`card mt-2 shadow ${styles.card1}`}>
                        <div className="card-body">
                            ...
                            <h6 className='text-capitalize mt-4'>the for person crew will now <br></br>
